...
while ($row=mysql_fetch_array ($result))
{
	...
	if ($row["member_id"]==null || $row["member_id"]==0)
	{
			...
			//20091201 rounding invoice >74102
			 if ($row["invoice_no"]>74102){
				// round 20091201
				$str1="<tr><td>".$row["invoice_no"]."</td><td>".number_format(round($row["round(sum(goods_invoice.marketprice*goods_invoice.qty*(100-goods_invoice.discountrate)/100),2)"]),2)."</td><td>".$row["invoice_date"]."</td><td>".$row["sales_name"]."</td><td>".$row["customer_name"]."</td><td>".$row["customer_tel"]."</td></tr>";
				}else{
	...
	else
	{
		...
		if ($row2["mem_tel"]=="")
	 	...
	 	//20091201 rounding invoice >74102
			 if ($row["invoice_no"]>74102){
				// round 20091201
				$str1="<tr><td>".$row["invoice_no"]."</td><td>".round($row["round(sum(goods_invoice.marketprice*goods_invoice.qty*(100-goods_invoice.discountrate)/100),2)"])."</td><td>".$row["invoice_date"]."</td><td>".$row["sales_name"]."</td><td>".$mem_name."</td><td>".$mem_tel."</td><td>".$row["member_id"]."</td></tr>";
				}else{
