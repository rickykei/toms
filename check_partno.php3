...
$today=date("Y-m-d");     
$lastyear  = date("Y-m-d 00:00:00",mktime(0, 0, 0, date("m"),  date("d"),  date("Y")-1));
...
/////
   ...
   $query2="select * from sumgoods,goods_invoice,invoice where goods_invoice.goods_partno = \"".$goods_partno."\" and sumgoods.goods_partno=goods_invoice.goods_partno and goods_invoice.invoice_no=invoice.invoice_no and sumgoods.admin_view=\"N\" and invoice.invoice_date >\"".$lastyear."\" order by invoice.invoice_no desc";
   ...
   $query7="select * from goods_invoice,invoice where goods_invoice.invoice_no=invoice.invoice_no and goods_partno=\"".$goods_partno."\" and invoice.invoice_date >\"".$lastyear."\" order by goods_invoice.invoice_no  desc";
...
</td></tr><tr><td> </td></tr><tr><td><a href="check_partno_with_ingoods.php?update=3&goods_partno=<?=urlencode($goods_partno)?>">顯示入貨的相關資料</a></td></tr></table>
<br>
      <?
