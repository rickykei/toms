...
function first_text_box_focus()
{
	...
	document.getElementById('width0').focus();
...
function cal_feet(evt,box,number){
var aa=0;
aa=((document.getElementById('width'+number).value)*(document.getElementById('height'+number).value))/144;
document.getElementById('feet'+number).value=aa.toFixed(2);
next_text_box(evt,box);
}

function cal_total(evt,box,number){
var aa=0;
aa=document.getElementById('unitprice'+number).value/24*document.getElementById('feet'+number).value*document.getElementById('qty'+number).value;
document.getElementById('total'+number).value=aa.toFixed(0);
cal_subtotal();
next_text_box(evt,box);
}
...
function cal_subtotal(){
	...
	var aa=0;
	for(i=0;i<8;i++){
		aa=parseInt(aa) + parseInt(document.getElementById('total'+i).value);
	}
	
	document.getElementById('countid').value=aa;
}
