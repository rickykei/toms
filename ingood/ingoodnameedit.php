...
if ($update==1)
  {
   ...
   $query="update sumgoods set model='$model',goods_detail='$goods_detail',market_price=$market_price ,remark='$remark' , unitid='$unitid', inshop_quota='$inshop_quota' where goods_partno='$goods_partno'";
