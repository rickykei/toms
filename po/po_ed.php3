...
*/
 ...
 $cherr=0;
   if ($customer=="y")
//      $query="insert into po (po_no,po_date,sales_name,customer_name,customer_tel,customer_detail,status) values ('$po_no','$po_date','$sales_name','$customer_name','$customer_tel','$customer_detail','Y')";
      $query="update po set po_date='$po_date', sales_name='$sales_name', customer_name='$customer_name', customer_tel='$customer_tel', customer_detail='$customer_detail', member_id='' where po_no=$po_no";
   else if ($customer=="n")
      $query="update po set po_date='$po_date', sales_name='$sales_name', customer_name='', customer_tel='', customer_detail='', member_id='$member_id' where po_no=$po_no";
//      $query="insert into po (po_no,po_date,sales_name,member_id,status) values ('$po_no','$po_date','$sales_name',$member_id,'Y')";
...
$query4="delete from goods_po where po_no=$po_no";  //delete old record
...
//   }
   ...
   {
      echo "資料順利輸入!<br>";
      include("show_and_create_po.php3");
   }
   else
