...
{
   #$query1="select * from wai_excel where goods_partno=\"".$goods_partno."\" ";
   if ($update==2&&$model!="")
   $query1="select * from wai_excel where goods_partno like \"$goods_partno%\" and model like '$model%' and admin_view=\"N\"";
   else
   $query1="select * from wai_excel where goods_partno like \"$goods_partno%\" order by goods_partno";
   if ($update==3)
   $query1="select * from wai_excel where goods_partno = \"$goods_partno\"  ";
