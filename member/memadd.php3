...
$query = $query . "(mem_id,mem_name_eng,mem_name_chi,mem_hkid,mem_dob,mem_tel,";
$query = $query . "mem_tel2,mem_add,mem_carno,mem_cartype,mem_caryear,";
$query = $query . "mem_carno2,mem_cartype2,mem_caryear2,apply_date,exp_date,other,barcode) ";
$query = $query . "values ('$mem_id','$mem_name_eng','$mem_name_chi','$mem_hkid','$dob','$mem_tel',";
$query = $query . "'$mem_tel2','$mem_add','$mem_carno','$mem_cartype','$mem_caryear',";
$query = $query . "'$mem_carno2','$mem_cartype2','$mem_caryear2','$apply_date','$exp_date','$other','$barcode')";
