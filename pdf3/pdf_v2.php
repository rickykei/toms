...
function Body($goods_partno,$goods_detail,$qty,$market_price,$discountrate,$invoice_no,$customer_name,$invoice_date,$customer_car_no,$customer_tel,$mile)
{  
$this->SetXY(0,-1);
...
$this->SetY(42);
    ...
    $this->SetFont($fontname,'',10,false);
	 ...
	 $this->Cell(30,$h,"INVOICE NO:",$border,0,'R',0);
	 $this->Cell($c7,$h,"T".$invoice_no."",$border,1,'L',0);
	...
	$this->Cell($c1,$h,"",$border,0,'L',0);
	 ...
	 $this->Cell($c7,$h,"".$invoice_date."",$border,1,'L',0);	 
